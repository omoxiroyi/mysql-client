...
public class LogBuffer {
    ...
    public final LogBuffer duplicate(final int pos, final int len) {
        ...
        byte[] buf = Arrays.copyOfRange(buffer, pos, pos + len);
    ...
    public final String getFixString(final int pos, final int len, String charsetName) {
        ...
        try {
            return new String(buf, pos, found - pos, charsetName);
     ...
     * Return 16-bit signed int from buffer. (big-endian)
     */
    private static int getInt16BE(byte[] buffer, final int pos) {
     ...
     */
    private static int getInt24BE(byte[] buffer, final int pos) {
     ...
     */
    private static int getInt32BE(byte[] buffer, final int pos) {
    ...
    public final BigDecimal getDecimal(final int precision, final int scale) {
        ...
        final int frac0 = scale / DIG_PER_INT32;
        final int intg0x = intg - intg0 * DIG_PER_INT32;
        final int frac0x = scale - frac0 * DIG_PER_INT32;
        ...
        BigDecimal decimal = getDecimal0(position, intg, scale, // NL
     ...
     * </pre>
     */
    private BigDecimal getDecimal0(final int begin, final int intg, final int frac, final int intg0,
     ...
     * @param len The length of MY_BITMAP in bits.
     */
    private int fillBitmap0(BitSet bitmap, int pos, final int len) {
