...
import com.dingcloud.dts.binlog.event.impl.RowData;
import com.dingcloud.dts.binlog.event.impl.RowDataEvent;
import com.dingcloud.dts.binlog.event.impl.TableMapEvent;
import com.dingcloud.dts.binlog.event.impl.TableMapEvent.ColumnInfo;
import com.dingcloud.dts.binlog.mysql.dbsync.BinlogContext;
import com.dingcloud.dts.binlog.mysql.dbsync.LogBuffer;
import com.dingcloud.dts.binlog.util.JsonConversion;
import com.dingcloud.dts.binlog.util.MySQLConstants;
import com.dingcloud.dts.binlog.util.JsonConversion.Json_Value;
...
public class RowDataEventParser implements BinlogEventParser {
	...
	private void parseRow(LogBuffer buffer, RowData row, TableMapEvent tableMap, BitSet colBit, boolean isAfter,
		...
		for (int i = 0; i < columnLen; i++) {
			...
			ColumnInfo cInfo = tableMap.getColumnInfo()[i];
